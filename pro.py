...
def main():
	while True:
		...
		print ("1) SMS BOMBER.\n2) Update Proxy(Beta).\n3) Exit.\n")
		input1 = input(Fore.BLUE+"What do you wan't?: "+Style.RESET_ALL)
		if input1 == "1":
			try:
				print('Enter number: ')
				...
				try:
					print ("Enter proxy http(s)://IP:port proxy.")
					print ("Exemple: "+Fore.GREEN+"https://123.45.6.78:8080"+Style.RESET_ALL)
					print ("For stop type CTRL+C")
