...
def Main():
	...
	def main():
		...
		while True:
			...
			if input1 == "1":
				try:
					print('Enter victim number :')
					phone = input("spymer > ")
					try:
						if int(phone):
							print('Enter the number of the levels(level=power):')
							count = input("spymer > ")
							try:
								if int(count):
									count=int(count)
									...
									if int(id) > 0:
										info = Fore.RED+"\nThis number are secured."+Style.RESET_ALL
									elif int(id)==0:
										_name = ''
										for x in range(12):
										...
										email = _email
										info = 'To stop press CTRL+Z or CTRL+C.'
										os.system("clear")
										print(logo)
										print(info)
										if _phone[0] == '9':
					...
					try:
						if int(phone):
							...
							try:
								...
								id=requests.post('https://rainbow-t-shirt.com/spymer/json.php', data={'phone': _phone}).json()["id"]
								if int(id) > 0:
									info = Fore.RED+"\nNumber secured."+Style.RESET_ALL
									main()
								elif int(id)==0:
									_email = ''
									for x in range(12):
									...
									info="Number: {}\nName: {}\nSpam start.\nFor stop press Ctrl+C".format(phone, name, text)
									os.system("clear")
									print(logo)
									print(info)
									proxies=None
